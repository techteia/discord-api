...
DiscordAPI.prototype.readChannel = async function(channelId) {
  ...
  const response = await fetch(
    `${this.discordAPIBaseURL}/channels/${String(channelId)}`,
    {
      method: 'GET',
      headers: {
...
DiscordAPI.prototype.readChannelMessage = async function(channelId, messageId) {
  ...
  const response = await fetch(
    `${this.discordAPIBaseURL}/channels/${String(channelId)}/messages/${String(messageId)}`,
    {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
...
DiscordAPI.prototype.createChannelMessage = async function(channelId, body) {
  ...
  const response = await fetch(
    `${this.discordAPIBaseURL}/channels/${String(channelId)}/messages`,
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
DiscordAPI.prototype.deleteChannelMessages = async function(channelId, messages) {
  ...
  const response = await fetch(
    `${this.discordAPIBaseURL}/channels/${String(channelId)}/messages/bulk-delete`,
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
